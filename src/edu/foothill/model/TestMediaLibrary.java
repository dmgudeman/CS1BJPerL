...
//	//////	
		Video newVideo = new Video("Video7",  "location1",  "format1",  "notes1", "star1");
		mediaLibrary.addMedia((Media) newVideo);
		
		Book newBook = new 	Book("Book1" ,  "location1",  "format1",  "notes1", "author1");
		mediaLibrary.addMedia((Media) newBook);
		
		Song newSong = new Song("Song1" , "location1",  "format1",  "notes1",	"artist1", " genre1"); 
		mediaLibrary.addMedia((Media) newSong);
		
		Video newVideo1 = new Video("Video1",  "location1",  "format1",  "notes1", "star1");
		mediaLibrary.addMedia((Media) newVideo1);
		
		VideoGame newVideoGame = new VideoGame("VideoGame1", "location1",  "format1",  "notes1");
		mediaLibrary.addMedia((Media) newVideoGame);
		
		Video newVideo3 = new Video("Video3",  "location1",  "format1",  "notes1", "star1");
		mediaLibrary.addMedia((Media) newVideo3);
		Book newBook7 = new 	Book("Book7" ,  "location1",  "format1",  "notes1", "author1");
		mediaLibrary.addMedia((Media) newBook7);
		Book newBook3 = new 	Book("Book3" ,  "location1",  "format1",  "notes1", "author1");
		...
		while (menuOptionSelection != 0) {
			...
			case 7:
				...
				mediaTitle = consoleView.readTitle(true); // Title must be entered
